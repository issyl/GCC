                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-6 py-4 text-center">
                                <a href="{{ route('games.edit', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                    Edit
                                </a>
                                <form action="{{ route('games.destroy',$item->id) }}" method="POST" class="inline-block">
